...
<html lang="pt-br">
    <head>
        ...
        <title>Solidarity - Fazer o bem sem ver a quem.</title>

        <!-- METATAGS -->
        <meta charset="utf-8" />
        <meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
        <meta name="description" content="Ajude ONGs de todo país" />
    ...
    <body class="body">
        ...
        <main>
            <?php require("./src/components/parallax/parallax.php"); ?>
            <?php require("./src/components/texto-principal/texto-principal.php"); ?>
