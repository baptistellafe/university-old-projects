...
<html lang="pt-br">
    ...
    <body class="body-contato">
        ...
        <script>(function(d, s, id) {
          ...
          js.src = 'https://connect.facebook.net/pt_BR/sdk.js#xfbml=1&version=v2.12&appId=409254369518312&autoLogAppEvents=1';
        ...
        <main>
            <?php require("./src/components/parallax/parallax-contato.php"); ?>
            <?php require("./src/components/texto-principal/texto-principal-contato.php"); ?>
